...
<body>
		...
		<div
			...
			<nav id="navbar" class="navbar order-last order-lg-0">
				<ul>
					...
					<li><a class="nav-link scrollto" href="url.do?URL=regWriteForm.do"><span>신청하기</span></a>
						</li>
					...
					<li><a class="nav-link scrollto" href="regWriteForm.do"><span>신청하기</span></a>
						</li>
		...
		<div class="hero-container">
			<div id="heroCarousel" data-bs-interval="5000"
				...
				<div class="carousel-inner" role="listbox">
					...
					<!-- Slide 4 -->
					<div class="carousel-item"
						style="background: url(assets/img/slide/slide-4.png);">
					...
					<!-- Slide 3 -->
					<div class="carousel-item"
						style="background: url(assets/img/slide/slide-3.png);">
						<div class="carousel-background">
							<img src="assets/img/slide/slide-3.jpg" alt="">
						</div>
						<div class="carousel-container">
					...
					<div class="carousel-item active"
						style="background: url(assets/img/slide/slide-1.png);">
						<div class="carousel-container">
							<div class="carousel-content">
								<h2 class="animate__animated animate__fadeInDown">
									<span>성곽순례</span> 모집중
	...
	<h2 align="center">인기프로그램</h2><span align="right"><a href = "programList.do">더보기</a></span>
			<div class="col-sm-4" ><span>-<%=programBestList.get(0).getP_name()%>
			<img src= upload/<%=programBestList.get(0).getImage()%> alt="<%=programBestList.get(0).getImage()%>" title="<%=programBestList.get(0).getImage()%>" class="img-fluid"  onclick="javascript:location.href='programDetail.do?p_num=<%=programBestList.get(0).getP_num()%>';">
			</span></div>
			<div class="col-sm-4"><span>-<%=programBestList.get(1).getP_name()%>
			<img src= upload/<%=programBestList.get(1).getImage()%> alt="<%=programBestList.get(1).getImage()%>" title="<%=programBestList.get(1).getImage()%>" class="img-fluid" onclick="javascript:location.href='programDetail.do?p_num=<%=programBestList.get(1).getP_num()%>';">
			</span></div>
			<div class="col-sm-4"><span>-<%=programBestList.get(2).getP_name()%>
			<img src= upload/<%=programBestList.get(2).getImage()%> alt="<%=programBestList.get(2).getImage()%>" title="<%=programBestList.get(2).getImage()%>" class="img-fluid" onclick="javascript:location.href='programDetail.do?p_num=<%=programBestList.get(2).getP_num()%>';">
			</span></div>
	</div>
	<hr>
	<div class="row" id="portfolio-grid">
	<h2 align="center">최신프로그램</h2><span align="right"><a href = "programList.do">더보기</a></span>
			<div class="col-sm-4"><span>-<%=programLatestList.get(0).getP_name()%>
			<img src= upload/<%=programLatestList.get(0).getImage()%> alt="<%=programLatestList.get(0).getImage()%>" title="<%=programLatestList.get(0).getImage()%>" class="img-fluid"  onclick="javascript:location.href='programDetail.do?p_num=<%=programLatestList.get(0).getP_num()%>';">
			</span></div>
			<div class="col-sm-4"><span>-<%=programLatestList.get(1).getP_name()%>
			<img src= upload/<%=programLatestList.get(1).getImage()%> alt="<%=programLatestList.get(1).getImage()%>" title="<%=programLatestList.get(1).getImage()%>" class="img-fluid" onclick="javascript:location.href='programDetail.do?p_num=<%=programLatestList.get(1).getP_num()%>';">
			</span></div>
			<div class="col-sm-4"><span>-<%=programLatestList.get(2).getP_name()%>
			<img src= upload/<%=programLatestList.get(2).getImage()%> alt="<%=programLatestList.get(2).getImage()%>" title="<%=programLatestList.get(2).getImage()%>" class="img-fluid" onclick="javascript:location.href='programDetail.do?p_num=<%=programLatestList.get(2).getP_num()%>';">
			</span></div>
	</div>
...
<!-- ======= Footer ======= -->
	<footer id="footer">
		<div class="container">
			...
			이메일: alsdk9458@naver.com / Tel : 010-2410-9597 			
			</div>
