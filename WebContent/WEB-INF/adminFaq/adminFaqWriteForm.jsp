	...
	<section id="writeForm">
		<div class="row">
			...
			<div class="col-md-8">
				...
				<form action="faqWritePro.do" enctype="multipart/form-data" method="post" name = "writeForm">
				
					<table class="table table-striped">

						<tr>
							<td>작성자</td>
							<td><input type="text" class="form-control" "f_writer"
